...
public class ExceptionConstants {
    ...
    public static final String TRANSACTION_ENTITYID_INVALID = "Entity id is not present in the system. Cannot proceed for this request";
    ...
    public static final String TRANSACTION_SUCCESS = "Request went all the way through! ";
